...
import com.mycompany.serverproject1.IteratorPoPlanszy.IteratorUkosnyDoTylu;
 ...
 * @author Geoff
 */
public class MetodaIteratorUkosnyDoTylu implements IMetodaPlansza{

    @Override
    public IIteratorPlansza pobierzIterator(IPlansza p) {
        return new IteratorUkosnyDoTylu(p);
    }
